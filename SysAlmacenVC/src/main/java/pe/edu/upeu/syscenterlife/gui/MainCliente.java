...
public class MainCliente extends javax.swing.JPanel {
    ...
    public void listarClientes() {
        List<Cliente> listarCleintes = clienteService.listarEntiendad();
    ...
    private void initComponents() {
        ...
        txtBuscar.setText("EDDYSSON AMADEUS CURO ESCARCENA");
        ...
        if (jTable1.getSelectedRowCount() > 0) {
            try {
                ...
                if (JOptionPane.showConfirmDialog(this, "Esta seguro de eliminar este registrtro DNI: " + valor + "?", "Mensaje de confirmación", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE) == 0) {
                    ...
                    clienteService.eliminaEntidad(valor.toString());
                    resetForm();
                }
            } catch (Exception e) {
